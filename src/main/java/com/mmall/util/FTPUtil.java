...
public class FTPUtil {
    ...
    private static String ftpIp=PropertiesUtil.getProperty("127.0.0.1");
    private static String ftpUser=PropertiesUtil.getProperty("ftpuser");
    private static String ftpPassword=PropertiesUtil.getProperty("123456");
    ...
    private boolean connectServer(String ip,int port,String user,String password){
        ...
        try{
            ...
            suc = ftpClient.login(user,password);
        }catch (Exception e){
